    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-edit"></i> Chỉnh sửa sản phẩm: {{ $product->name }}</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Chỉ chọn file nếu muốn thay đổi hình ảnh. Chấp nhận: JPG, PNG, GIF. Kích thước tối đa: 2MB</div>
                            </div>
