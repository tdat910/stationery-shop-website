...
<head>
    ...
    <title>Đăng Ký - Stationery Shop</title>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="auth-card p-4">
                ...
                <div class="divider text-muted small">Hoặc</div>

                <a href="{{ route('google.login') }}" class="btn btn-google w-100 mb-3 text-dark">
    ...
    Đăng ký nhanh với Google
                ...
                <p class="text-center mt-3 mb-0">Đã có tài khoản? <a href="{{ route('login') }}" class="text-decoration-none">Đăng nhập</a></p>
            </div>
        </div>
    </div>
</div>
